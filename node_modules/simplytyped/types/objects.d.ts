 ...
 */
export declare type CombineObjects<T extends object, U extends object> = ObjectType<T & U>;
/**
 ...
 */
export declare type ObjectKeys = keyof any;
/**
 ...
 */
export declare type Intersect<T extends object, U extends Partial<T>> = Omit<U, DiffKeys<U, T>>;
/**
 ...
 */
export declare type Merge<T extends object, U extends object> = Overwrite<T, U> & U;
/**
 ...
 */
export declare type KeysByType<O extends object, T> = {
 ...
 */
export declare type StrictUnion<T> = _StrictUnionHelper<T, T>;
/** no-doc */
